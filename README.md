...
* POST   http://www.mydomain.com/users –data {name: jonh}
* DELETE http://www.mydomain.com/users/01
...
[ASP.NET Web API](https://docs.microsoft.com/en-us/aspnet/web-api/) é uma framework para construir Web APIs. Neste tutorial iremos construir um Cadastro de Produtos (CRUD), utilizando ASP.NET Web API.
